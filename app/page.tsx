...
function ShowcaseCarousel() {
  ...
  const cards: { event: string; name1: string; name2: string; he1?: string; he2?: string; date: string; lieu: string; accent: string; fond: string; verse?: string; parents?: string; joie?: string; honore?: string; oui?: boolean; dark?: boolean; bsd?: boolean; defunt?: string; buttons?: boolean; frame?: string }[] = [
    // 1 — Houppa bordeaux
    { event: 'LA HOUPPA', name1: 'Sarah', name2: 'David', he1: 'שרה', he2: 'דוד', date: '15 Juin 2026', lieu: 'Synagogue Beth-El, Paris', accent: '#8b1a2a', fond: '#fdf8f8', verse: 'קוֹל שָׂשׂוֹן וְקוֹל שִׂמְחָה קוֹל חָתָן וְקוֹל כַּלָּה', parents: 'M. & Mme Cohen · M. & Mme Lévy', joie: 'ont la joie de vous faire part du mariage de leurs enfants', honore: 'et seront honorés de votre présence à la cérémonie religieuse', bsd: true, defunt: 'Marie Cohen ז״ל', buttons: true, frame: 'https://gsihevihnthjsm8z.public.blob.vercel-storage.com/static/v1776785419/51_m9vx96.png' },
    // 2 — Mairie doré
    { event: 'LA MAIRIE', name1: 'Léa', name2: 'Antoine', date: '12 Juillet 2026', lieu: 'Mairie du 16e, Paris', accent: '#a08930', fond: '#fdf8f0', oui: true, honore: 'se diront', buttons: true, frame: 'https://gsihevihnthjsm8z.public.blob.vercel-storage.com/static/v1776857011/55_l7xahl.png' },
    // 3 — Shabbat Hatan bleu
    { event: 'SHABBAT HATAN', name1: 'Esther', name2: 'Nathan', he1: 'אסתר', he2: 'נתן', date: '20 Mars 2026', lieu: 'Synagogue Buffault, Paris', accent: '#2c4a7c', fond: '#f0f4f8', verse: '✡ ✦ ✡', parents: 'Les familles Azoulay & Mimoun', joie: 'ont la joie de vous convier au Shabbat Hatan de leurs enfants', bsd: true, buttons: true, frame: 'https://gsihevihnthjsm8z.public.blob.vercel-storage.com/static/v1776878838/96_bauksw.png' },
    // 4 — Houppa rose
    { event: 'LA HOUPPA', name1: 'Rachel', name2: 'Yossef', he1: 'רחל', he2: 'יוסף', date: '8 Mai 2026', lieu: 'Espace Rachi, Paris', accent: '#9a5a6a', fond: '#faf6f4', verse: 'קוֹל שָׂשׂוֹן וְקוֹל שִׂמְחָה קוֹל חָתָן וְקוֹל כַּלָּה', parents: 'M. & Mme Benaim · M. & Mme Toledano', joie: 'ont la joie de vous faire part du mariage de leurs enfants', honore: 'et seront honorés de votre présence à la houppa', bsd: true, defunt: 'Simha Benaim ז״ל', buttons: true, frame: 'https://gsihevihnthjsm8z.public.blob.vercel-storage.com/static/v1776878823/75_qc4gsm.png' },
    // 5 — Soirée champêtre
    { event: 'SOIRÉE', name1: 'Emma', name2: 'Raphaël', date: '28 Août 2026', lieu: 'Domaine de Montceau', accent: '#7a9e6e', fond: '#f4f7f0', joie: 'vous invitent à célébrer leur union', buttons: true, frame: 'https://gsihevihnthjsm8z.public.blob.vercel-storage.com/static/v1777896746/149_jwshu6.png' },
    // 6 — Mairie gris
    { event: 'LA MAIRIE', name1: 'Chloé', name2: 'Alexandre', date: '3 Avril 2026', lieu: 'Mairie du 8e, Paris', accent: '#555555', fond: '#f8f8f8', oui: true, honore: 'se diront', buttons: true, frame: 'https://gsihevihnthjsm8z.public.blob.vercel-storage.com/static/v1776878824/77_rnfcni.png' },
    // 7 — Beach party fuchsia
    { event: 'BEACH PARTY', name1: 'Inès', name2: 'Michaël', date: '10 Juillet 2026', lieu: 'Plage de Pampelonne', accent: '#d4006a', fond: '#fff0f8', joie: 'vous invitent à faire la fête avec eux', buttons: true, frame: 'https://gsihevihnthjsm8z.public.blob.vercel-storage.com/static/v1776878845/95_w9natp.png' },
    // 8 — Houppa marine & or
    ...
    // 9 — Cocktail menthe
    { event: 'COCKTAIL', name1: 'Julie', name2: 'Thomas', date: '14 Juin 2026', lieu: 'Jardin du Luxembourg', accent: '#2a9a6a', fond: '#f0faf5', joie: 'vous invitent à lever leur verre', buttons: true, frame: 'https://gsihevihnthjsm8z.public.blob.vercel-storage.com/static/v1777896741/150_rzlu80.png' },
    // 10 — Shabbat Hatan bordeaux
    { event: 'SHABBAT HATAN', name1: 'Léa', name2: 'Ariel', he1: 'לאה', he2: 'אריאל', date: '11 Octobre 2026', lieu: 'Synagogue de Boulogne', accent: '#8b1a2a', fond: '#fdf8f8', verse: '✡ ✦ ✡', parents: 'Les familles Benchetrit & Ohayon', joie: 'ont la joie de vous convier au Shabbat Hatan de leurs enfants', bsd: true, buttons: true, frame: 'https://gsihevihnthjsm8z.public.blob.vercel-storage.com/static/v1776878824/79_msrbl6.png' },
  ]
