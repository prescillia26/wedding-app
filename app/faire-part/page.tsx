...
{ id: 'frame-57', label: '🌸 Floral 57', url: 'https://res.cloudinary.com/dau96mui2/image/upload/v1776857012/57_nhmcb1.png' },
{ id: 'frame-58', label: '🌸 Floral 58', url: 'https://res.cloudinary.com/dau96mui2/image/upload/v1776857014/58_oivhja.png' },
{ id: 'frame-59', label: '🌸 Floral 59', url: 'https://res.cloudinary.com/dau96mui2/image/upload/v1776857013/59_po5os7.png' },
{ id: 'frame-60', label: '🌸 Floral 60', url: 'https://res.cloudinary.com/dau96mui2/image/upload/v1776857013/60_lm1qtk.png' },
{ id: 'frame-61', label: '🌸 Floral 61', url: 'https://res.cloudinary.com/dau96mui2/image/upload/v1776857014/61_nnkips.png' },
{ id: 'frame-63', label: '🌸 Floral 63', url: 'https://res.cloudinary.com/dau96mui2/image/upload/v1776857015/63_gksasl.png' },
{ id: 'frame-64', label: '🌸 Floral 64', url: 'https://res.cloudinary.com/dau96mui2/image/upload/v1776857016/64_p7j0i3.png' },
{ id: 'frame-65', label: '🌸 Floral 65', url: 'https://res.cloudinary.com/dau96mui2/image/upload/v1776857017/65_hzdotl.png' },
{ id: 'frame-66', label: '🌸 Floral 66', url: 'https://res.cloudinary.com/dau96mui2/image/upload/v1776857021/66_vgyksj.png' },
{ id: 'frame-67', label: '🌸 Floral 67', url: 'https://res.cloudinary.com/dau96mui2/image/upload/v1776857018/67_so3kot.png' },
{ id: 'frame-68', label: '🌸 Floral 68', url: 'https://res.cloudinary.com/dau96mui2/image/upload/v1776857019/68_wvtkkm.png' },
          ...
          <div style={{ background: 'white', border: `1.5px solid ${theme.accent}33`, borderRadius: 12, height: 190, overflow: 'hidden', boxShadow: `0 12px 48px ${theme.accent}33` }}>
            {data.photosFond?.[0] ? (
              ...
              <div style={{ width: '100%', height: '100%', background: `linear-gradient(135deg, ${theme.fond}, ${theme.accent}18)`, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <MonogramByStyle initial1={(data.marie1Prenom || 'A')[0].toUpperCase()} initial2={(data.marie2Prenom || 'B')[0].toUpperCase()} color={theme.accent} size={70} style={data.monogrammeStyle || 'cercle'} />
              </div>
            )}
            {/* V en bas */}
