...
const FRAMES: { id: string; label: string; url: string | null }[] = [
  ...
  { id: 'frame-11', label: '🌺 Fleurs Colorées 40', url: 'https://res.cloudinary.com/dau96mui2/image/upload/v1776778898/40_ppuque.png' },
  { id: 'frame-12', label: '🌷 Fleurs Roses 39', url: 'https://res.cloudinary.com/dau96mui2/image/upload/v1776778892/39_jm4xr1.png' },
  { id: 'frame-13', label: '💐 Bouquet 38', url: 'https://res.cloudinary.com/dau96mui2/image/upload/v1776778890/38_oqgl8d.png' },
  { id: 'frame-14', label: '🌹 Roses 36', url: 'https://res.cloudinary.com/dau96mui2/image/upload/v1776778886/36_avfbex.png' },
  { id: 'frame-15', label: '🌸 Floral 35', url: 'https://res.cloudinary.com/dau96mui2/image/upload/v1776778883/35_q7ho0k.png' },
  { id: 'frame-16', label: '🌺 Floral 34', url: 'https://res.cloudinary.com/dau96mui2/image/upload/v1776778878/34_patt7q.png' },
  { id: 'frame-17', label: '💮 Floral 32', url: 'https://res.cloudinary.com/dau96mui2/image/upload/v1776778875/32_c0k1wu.png' },
  { id: 'frame-18', label: '🌷 Floral 31', url: 'https://res.cloudinary.com/dau96mui2/image/upload/v1776778871/31_wkhd5e.png' },
  { id: 'frame-19', label: '🌼 Floral 30', url: 'https://res.cloudinary.com/dau96mui2/image/upload/v1776778868/30_inltdl.png' },
  { id: 'frame-20', label: '🌻 Floral 29', url: 'https://res.cloudinary.com/dau96mui2/image/upload/v1776778866/29_sv2l8b.png' },
  { id: 'frame-21', label: '🌸 Floral 28', url: 'https://res.cloudinary.com/dau96mui2/image/upload/v1776778861/28_obhp8w.png' },
  { id: 'frame-22', label: '🌹 Floral 27', url: 'https://res.cloudinary.com/dau96mui2/image/upload/v1776778858/27_nfg9j1.png' },
  { id: 'frame-23', label: '💐 Floral 26', url: 'https://res.cloudinary.com/dau96mui2/image/upload/v1776778856/26_f63vab.png' },
  { id: 'frame-24', label: '🌺 Floral 25', url: 'https://res.cloudinary.com/dau96mui2/image/upload/v1776778851/25_qhmedq.png' },
  { id: 'frame-25', label: '🌷 Floral 24', url: 'https://res.cloudinary.com/dau96mui2/image/upload/v1776778848/24_lpzfts.png' },
  { id: 'frame-26', label: '🌼 Floral 23', url: 'https://res.cloudinary.com/dau96mui2/image/upload/v1776778843/23_r1h7uf.png' },
  { id: 'frame-27', label: '🌿 Floral 21', url: 'https://res.cloudinary.com/dau96mui2/image/upload/v1776778835/21_pyegeh.png' },
  { id: 'frame-28', label: '🌸 Floral 20', url: 'https://res.cloudinary.com/dau96mui2/image/upload/v1776778833/20_vgfnr3.png' },
  { id: 'frame-29', label: '🌺 Floral 19', url: 'https://res.cloudinary.com/dau96mui2/image/upload/v1776778827/19_dasahe.png' },
  { id: 'frame-30', label: '🌹 Floral 18', url: 'https://res.cloudinary.com/dau96mui2/image/upload/v1776778825/18_ushe4t.png' },
  { id: 'frame-31', label: '💮 Floral 17', url: 'https://res.cloudinary.com/dau96mui2/image/upload/v1776778823/17_ftrc0s.png' },
